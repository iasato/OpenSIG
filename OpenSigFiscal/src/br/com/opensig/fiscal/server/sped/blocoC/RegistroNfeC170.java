	...
	protected DadosC170 getDados(Det dados) throws Exception {
		...
		if (pis != null) {
			if (pis.getPISAliq() != null) {
				...
				d.setAliq2_pis(pis.getPISOutr().getVAliqProd() == null ? 0.00 : Double.valueOf(pis.getPISOutr().getVAliqProd()));
		...
		if (cofins != null) {
			if (cofins.getCOFINSAliq() != null) {
				...
				d.setAliq2_cofins(cofins.getCOFINSOutr().getVAliqProd() == null ? 0.00 : Double.valueOf(cofins.getCOFINSOutr().getVAliqProd()));
