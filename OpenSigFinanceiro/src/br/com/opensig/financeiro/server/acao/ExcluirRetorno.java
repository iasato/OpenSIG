...
public class ExcluirRetorno extends Chain {
	...
	public ExcluirRetorno(Chain next, CoreServiceImpl servico, FinRetorno retorno) throws OpenSigException {
		super(next);
	...
	public void execute() throws OpenSigException {
		...
		try {
			...
			for (String bol : retorno.getFinRetornoBoletos().split(" ")) {
				...
				FiltroBinario fb = new FiltroBinario("finRecebimentoQuitado", ECompara.IGUAL, 1);
				GrupoFiltro gf1 = new GrupoFiltro(EJuncao.E, new IFiltro[] { fn, fb });
				...
				ParametroTexto pt = new ParametroTexto("finRecebimentoObservacao", "");
