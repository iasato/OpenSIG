...
public class ExcluirPagar extends Chain {
	...
	public ExcluirPagar(Chain next, CoreServiceImpl servico, FinPagar pagar) throws OpenSigException {
		super(next);
	...
	public void execute() throws OpenSigException {
		...
		try {
			...
			FiltroBinario fb = new FiltroBinario("finPagamentoQuitado", ECompara.IGUAL, 1);
