...
public class ListagemEcfVendaProduto extends AListagem<ComEcfVendaProduto> {
	...
	public void inicializar() {
		// campos
		FieldDef[] fd = new FieldDef[] { new IntegerFieldDef("comEcfVendaProdutoId"), new IntegerFieldDef("comEcfVenda.comEcfVendaId"), new IntegerFieldDef("comEcfVenda.comEcf.comEcfId"), new StringFieldDef("comEcfVenda.comEcf.comEcfSerie"),
				new IntegerFieldDef("comEcfVenda.comEcf.empEmpresa.empEmpresaId"), new StringFieldDef("comEcfVenda.comEcf.empEmpresa.empEntidade.empEntidadeNome1"),
				new StringFieldDef("comEcfVenda.empCliente.empEntidade.empEntidadeNome1"), new StringFieldDef("prodProduto.empFornecedor.empEntidade.empEntidadeNome1"),
				...
				new IntegerFieldDef("prodEmbalagem.prodEmbalagemId"), new StringFieldDef("prodEmbalagem.prodEmbalagemNome"), new FloatFieldDef("comEcfVendaProdutoValor"),
		...
		SummaryColumnConfig ccValor = new SummaryColumnConfig(SummaryColumnConfig.SUM, new ColumnConfig(OpenSigCore.i18n.txtValor(), "comEcfVendaProdutoValor", 75, true, DINHEIRO), DINHEIRO);
		...
		BaseColumnConfig[] bcc = new BaseColumnConfig[] { ccId, ccVendaEcfId, ccEcfId, ccEcf, ccEmpresaId, ccEmpresa, ccCliente, ccFornecedor, ccProdId, ccBarra, ccProduto, ccReferencia, ccData, ccQuantidade,
				ccEmbalagemId, ccEmbalagem, ccValor, ccTotal, ccCancelado, ccOrdem };
		modelos = new ColumnModel(bcc);

		if (UtilClient.getAcaoPermitida(funcao, ComandoPermiteEmpresa.class) == null) {
			filtroPadrao = new FiltroObjeto("comEcfVenda.comEcf.empEmpresa", ECompara.IGUAL, new EmpEmpresa(Ponte.getLogin().getEmpresaId()));
		}
