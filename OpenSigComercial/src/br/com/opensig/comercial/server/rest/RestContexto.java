...
public class RestContexto extends MOXyJsonProvider implements ContextResolver<JAXBContext> {
	...
	private Class[] types = { SisEmpresa.class, EmpEstado.class, EmpMunicipio.class, SisUsuario.class, ProdEmbalagem.class, ProdProduto.class, ProdPreco.class, ProdComposicao.class, ComEcf.class,
