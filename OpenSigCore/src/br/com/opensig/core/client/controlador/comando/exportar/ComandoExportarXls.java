...
/**
 * Classe de exportacao do tipo XSL.
 * 
 * @author Pedro H. Lira
 * @version 1.0
 */
public class ComandoExportarXls extends ComandoExportar {

	/**
	 * Construtor padrao que define o modo como LISTAGEM.
	 */
	public ComandoExportarXls() {
		this(EModo.LISTAGEM);
	}
	 ...
	 */
	public ComandoExportarXls(EModo modo) {
		super(EArquivo.XLS, modo);
	}
