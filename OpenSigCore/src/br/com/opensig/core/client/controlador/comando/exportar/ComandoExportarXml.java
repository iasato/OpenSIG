...
/**
 * Classe de exportacao do tipo XML.
 * 
 * @author Pedro H. Lira
 * @version 1.0
 */
public class ComandoExportarXml extends ComandoExportar {

	/**
	 * Construtor padrao que define o modo como LISTAGEM.
	 */
	public ComandoExportarXml() {
		this(EModo.LISTAGEM);
	}
	 ...
	 */
	public ComandoExportarXml(EModo modo) {
		super(EArquivo.XML, modo);
	}
